...
// PUT - Cập nhật trạng thái thanh toán (VNPAY callback)
billRouter.put('/payment/update', billController.updatePaymentStatus);

// PUT - Xác nhận thanh toán tiền mặt
billRouter.put('/payment/cash', billController.confirmCashPayment);
